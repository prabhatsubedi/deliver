            ...
            <div class="profile_container">
                ...
                <div class="profile_header">
                    <div class="profile_header_image">
                        <div id="drop_zone" class="form-group profile_image unselectable text-center image_selected">
                        </div>
                    ...
                    <div class="profile_info">
                        ...
                        <div class="info_block name">
                            ...
                            <div class="val">
                                ...
                                <div class="info_edit editable"><input type="text" id="fullName"></div>
                            </div>
                        </div>
                        <div class="info_block email">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="email"></div>
                            </div>
                        </div>
                        <div class="info_block mobile">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="mobile"></div>
                            </div>
                        </div>
                        <div class="info_block password">
                            <div class="label"> Password:</div>
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="password" id="password"></div>
                            </div>
                        </div>
                        <div class="info_block gender">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><select class="form-control" type="text" id="gender">
                        ...
                        <div class="info_block street">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="street"></div>
                            </div>
                        </div>
                        <div class="info_block city">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="city"></div>
                            </div>
                        </div>
                        <div class="info_block state">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="state"></div>
                            </div>
                        </div>
                        <div class="info_block country">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="country" disabled="disabled"></div>
                            </div>
                        </div>
                        <div class="info_block vehicle_type">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><select class="form-control" type="text" id="vehicleType">
                        ...
                        <div class="info_block state vehicle_no">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="vehicleNo"></div>
                            </div>
                        </div>
                        <div class="info_block state license_no">
                            ...
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><input type="text" id="licenseNo"></div>
                            </div>
                        </div>
                        <div class="info_block state status">
                            <div class="label"> Status: </div>
                            <div class="val">
                                <div class="info_display none_editable"></div>
                                <div class="info_edit editable"><select class="form-control" type="text" id="status">
