    ...
    <div class="sidebar_menu">
        <sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_MANAGER')">
            <ul class="nav nav-stacked">
                <li><a href="/organizer/dashboard" class="elem_tooltip" data-placement="right" title="Admin Dashboard"><span class="delivricon delivricon-dashboard"></span><span class="menu_text">Admin Dashboard</span></a></li>
                <li><a href="javascript:;" class="ignore_focus elem_tooltip merchant_title" data-placement="right" title="Merchant Name"><span class="delivricon delivricon-merchant"></span><span class="menu_text merchant_name">Merchant Name</span></a>
        </sec:authorize>
                    <ul class="nav nav-stacked">
                        <sec:authorize access="!hasAnyRole('ROLE_ADMIN', 'ROLE_MANAGER')">
                        <%--<li><a class="merchant_name ignore_focus" href="javascript:;">Merchant Name</a></li>--%>
                        </sec:authorize>
                        <li><a href="/merchant/store/list" class="elem_tooltip" data-placement="right" title="Stores"><span class="delivricon delivricon-store"></span><span class="menu_text">Stores</span></a></li>
                        <li><a href="/merchant/item/list" class="elem_tooltip" data-placement="right" title="Items"><span class="delivricon delivricon-item"></span><span class="menu_text">Items</span></a></li>
...
//            $(".sidebar .merchant_title").tooltip({title: sess_merchants[Main.getFromLocalStorage('mid')]});
        }
