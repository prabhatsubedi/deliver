...
INSERT INTO `delivr_db`.`preferences` (`pref_key`, `value`, `section_id`, `pref_title`) VALUES ('DEFAULT_DELIVERY_FEE_IN_FLAT_MODEL', '30', '11', 'Default Delivery Fee In Flat Model');
