    ...
    <div class="sidebar_inner">
        ...
        <div class="sidebar_menu">
            <ul class="nav nav-stacked">
                ...
                <li><a href="/organizer/customers" class="elem_tooltip" data-container=".tooltip_conatiner" data-placement="right" title="Inactive Customers"><span class="delivricon delivricon-merchant"></span><span class="menu_text">Inactive Customers</span></a></li>
