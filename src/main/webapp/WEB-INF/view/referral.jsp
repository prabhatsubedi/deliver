...
<div class="container">
    <div class=row>
        ...
        <div class="span12">
            <center><img src="/resources/images/login-logo.png" width="20%"/></center>
        </div>
    </div>
    <div class="hero-unit">
        <h2>Welcome to Delivr!</h2>
        <blockquote>
            <p class="info">
    ...
    <div class="well">
        <center>
            ...
            <div id="new_account_msg">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.yetistep.swipr"><img src="/resources/images/play_store_black.png" class="play_store"/></a>
            </div>
