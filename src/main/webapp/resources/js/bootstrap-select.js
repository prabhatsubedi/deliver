            ...
            this.$menu.on('click', 'li a', function(e) {
                var clickedIndex = $(this).parent().index(),
                    ...
                    prevIndex = that.$element.prop('selectedIndex');
								...
								var $option_all = that.$element.find('option[value="All"]');
								var $option = $options.eq(clickedIndex);
								$options.splice(clickedIndex, 1);

                //Dont close on multi choice menu
                if (that.multiple) {
										if($option.val() == 'All')
										{	
											if($option_all.prop('selected'))
											{	
												$option_all.prop('selected', true);											
											}
											else
											{
												$options.prop('selected', false);
												$option_all.prop('selected', false);	
											}
										}
										else
										{
...
/*										if($option.val() == 'All')
        ...
        selectAll: function() {
            ...
            this.$element.find('option[value="All"]').prop('selected', true).attr('selected', 'selected');
            this.render();
        },
