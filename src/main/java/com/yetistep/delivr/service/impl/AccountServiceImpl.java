...
public class AccountServiceImpl extends AbstractManager implements AccountService{
    ...
    @Override
    public String generateBillAndReceiptAndSendEmail(OrderEntity orderJson) throws Exception{
                ...
                if(orderProcessed) {
                    ...
                    if(advanceAmount.size() > 0){
                        ...
                        for (DBoyAdvanceAmountEntity dBoyAdvanceAmount: advanceAmount){
                            ...
                            transferredDBoy.setBankAccountNumber(processOrder.getDeliveryBoy().getBankAccountNumber());
