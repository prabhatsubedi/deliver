...
public enum PreferenceType {
    ...
    COMPANY_ADDRESS,CONTACT_NO,COMPANY_EMAIL,COMPANY_WEBSITE,VAT_NO,REGISTRATION_NO,

    //Default Images
    DEFAULT_IMG_ITEM, DEFAULT_IMG_CATEGORY, DEFAULT_IMG_SEARCH,

    ANDROID_APP_VER_NO, WEB_APP_VER_NO, HELPLINE_NUMBER, ACCEPTANCE_RADIUS, CUSTOMER_CARE_EMAIL,

    MINIMUM_TRANSFERABLE_AMOUNT, INR_CONVERSION_RATE;
}
