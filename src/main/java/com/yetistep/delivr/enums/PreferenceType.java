...
public enum PreferenceType {
    ...
    REFERRAL_REWARD_AMOUNT, REFEREE_REWARD_AMOUNT, MAX_REFERRED_FRIENDS_COUNT,NORMAL_USER_BONUS_AMOUNT, DBOY_GRESS_TIME, DBOY_DEFAULT_RATING, CUSTOMER_DEFAULT_RATING,

    //Default Images
    DEFAULT_IMG_ITEM, DEFAULT_IMG_CATEGORY,
