...
<%@include file="../includes/header.jsp" %>
    <div class="body">
        <div class="heading clearfix">
            <h1 class="pull-left">Shopper Profile</h1>
        </div>
                        ...
                        <div class="form_container form_editable full_width clearfix">
                            <div class="profile_info col-lg-5">
                                ...
                                <div class="form-group clearfix">
                                    <label for="full_name" class="col-lg-4 floated_label no_pad">Name of Shopper</label>
                                    <div class="col-lg-8">
                            ...
                            <div class="profile_map form-group col-lg-7">
                                <div class="profile_sub_title">Shopper Location</div>
